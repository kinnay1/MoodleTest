...
$ADMIN->add('reports', new admin_externalpage('organizereport',
    get_string('pluginname', 'report_organizereport'),
    $CFG->wwwroot.'/report/organizereport/index.php', 'report/organizereport:view'));
